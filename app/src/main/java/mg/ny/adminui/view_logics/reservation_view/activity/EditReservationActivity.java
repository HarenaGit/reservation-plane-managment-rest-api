...
public class EditReservationActivity extends AppCompatActivity {
    ...
    private ReservationDataModel reservData;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_edit_reservation);
        reservData = (ReservationDataModel) getIntent().getParcelableExtra("data");
        ...
        numPlacePosition = getPlaceDataPosition();
        numVolPosition = getFlightDataPosition();
        numPlace.post(new Runnable() {
            @Override
            public void run() {
                numPlace.setSelection(numPlacePosition);
            }
        });
